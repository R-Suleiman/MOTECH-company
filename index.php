    ...
    <div class="container-xxl bg-white p-0">
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img
                class="w-100"
                src="assets/images/images (13).jpeg"
                alt="Image"
              />
              <div
            ...
            <div class="carousel-item">
              <img
                class="w-100"
                src="assets/images/images (12).jpeg"
                alt="Image"
              />
              <div
                class="carousel-caption d-flex flex-column align-items-center justify-content-center"
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <h1
                    ...
                    style="font-size: 50px"
                  >
                    The Best and High Quality Digital Solutions
                  </h1>
                  <!-- <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Our Rooms</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Book A Room</a> -->
                </div>
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <h1
                    ...
                    style="font-size: 50px"
                  >
                    Quality Designs and Comprehensive Branding
                  </h1>
                  <!-- <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Our Rooms</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Book A Room</a> -->
                </div>
        ...
        <div class="container">
          <div class="row g-5 align-items-center">
            <div class="col-lg-6">
              ...
              <h1 class="mb-4">
                Welcome to <span class="text-primary">MOTECH</span>
              </h1>
              <p class="mb-4">
                MOTECH Company is more than a creative agency; It's the
                realization of a shared vision brought to life by three
                visionary brothers. Founded on the principles of creativity,
                innovation, and reliability, MOTECH is dedicated to delivering
                cutting-edge solutions in graphic design, video production, web
              ...
              <div class="row g-3">
                ...
                <div class="col-6 text-end">
                  <img
                    ...
                    data-wow-delay="0.5s"
                    src="assets/images/soft dev.jpeg"
                  />
                </div>
                <div class="col-6 text-start">
                  <img
                    class="img-fluid rounded w-75 wow zoomIn"
                    data-wow-delay="0.7s"
                    src="assets/images/security 2.png"
                  />
                </div>
              </div>
            </div>
              ...
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  <div class="d-flex justify-content-between mb-3">
                    <h5 class="mb-0" style="font-size: 18px">Graphic Design</h5>
                    <!-- <div class="ps-2">
                  ...
                  <p class="text-body mb-3">
                    From impactful logos to comprehensive branding, we craft
                    designs tha leave a lasting impression
                  </p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  ...
                  <p class="text-body mb-3">
                    Transforming ideas into interactive and functional web
                    applications, we redifine digital experience
                  </p>
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href=""
                      >View Detail</a
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/images/images (15).jpeg"
                    alt=""
                  />
                  <small
                    class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4"
                ...
                <div class="p-4 mt-2">
                  ...
                  <p class="text-body mb-3">
                    Our skilled team produces captivating corporate videos,
                    promotional content, and engaging animations
                  </p>
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href=""
                      >View Detail</a
          ...
          <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  <div class="d-flex justify-content-between mb-3">
                    <h5 class="mb-0" style="font-size: 18px">Photography</h5>
                    <!-- <div class="ps-2">
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                  ...
                  <p class="text-body mb-3">
                    Capturing moments with precision, our photography services
                    include product photography, and event coverage
                  </p>
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href=""
                      >View Detail</a
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  ...
                  <p class="text-body mb-3">
                    From oprating systems to custom software installations, and
                    maintenance, our company offers quality services
                  </p>
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href=""
                      >View Detail</a
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/images/images (16).jpeg"
                    alt=""
                  />
                  <small
                    class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4"
                ...
                <div class="p-4 mt-2">
                  ...
                  <p class="text-body mb-3">
                    Advice & guidance on technology planning, implementation,
                    and management.
                  </p>
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href=""
      ...
      <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="mb-5">
          ...
          <span class="text-primary text-uppercase">Us</span>
        </h1>
      </div>
      <div
